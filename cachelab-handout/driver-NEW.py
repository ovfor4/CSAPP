...
#
# NOTE: This is a Python 3 port of the original CS:APP cachelab driver.py
#       (which was written for Python 2). Changes made:
#         - print statements -> print() function calls
#         - subprocess.Popen(..., text=True) so stdout comes back as str
#           instead of bytes
#         - map(int, ...) wrapped in list(...) since map() is lazy in Py3
#
import subprocess
import re
import os
